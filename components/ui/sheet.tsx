  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Popup
        ...
        data-side={side}
        className={cn(
          "fixed z-50 flex flex-col bg-popover bg-clip-padding text-sm text-popover-foreground shadow-lg transition duration-200 ease-in-out data-ending-style:opacity-0 data-starting-style:opacity-0",
          ...
          "data-[side=left]:sm:max-w-sm data-[side=right]:sm:max-w-sm data-[side=left]:sm:w-3/4 data-[side=right]:sm:w-3/4",
...
function SheetHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("flex flex-col gap-0.5 p-6 pb-4 sticky top-0 bg-popover z-10", className)}
      {...props}
    />
  )
}
...
function SheetFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("mt-auto flex flex-col gap-2 p-6 sticky bottom-0 bg-popover z-10 sm:flex-row sm:justify-end border-t border-border", className)}
      {...props}
    />
  )
}
